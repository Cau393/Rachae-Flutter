...
void main() {
  ...
  group('fetchGroups', () {
    test(
      'calls GET /groups/ with no query parameters and parses two items',
      () async {
        when(
          () => mockDio.get<dynamic>(
            '/groups/',
          ...
          (_) async => Response<dynamic>(
            data: [
              _summaryItem('22222222-2222-2222-2222-222222222222', 'A'),
              _summaryItem('33333333-3333-3333-3333-333333333333', 'B'),
            ],
            statusCode: 200,
    ...
    test('propagates DioException with nested ApiException on 403', () async {
      when(
        () => mockDio.get<dynamic>(
          '/groups/',
          queryParameters: any(named: 'queryParameters'),
  ...
  group('fetchEligibleGroupsForFriend', () {
    test('calls GET /groups/eligible-friend-groups/ with user_id', () async {
      const friendId = '99999999-9999-9999-9999-999999999999';
      when(
        () => mockDio.get<dynamic>(
        ...
        (_) async => Response<dynamic>(
          data: [
            _summaryItem('22222222-2222-2222-2222-222222222222', 'Eligible'),
          ],
          statusCode: 200,
          requestOptions: RequestOptions(
            path: '/groups/eligible-friend-groups/',
          ),
        ),
      );

      final result = await repo.fetchEligibleGroupsForFriend(friendId);
      expect(result, hasLength(1));
      expect(result.first.name, 'Eligible');

      verify(
        () => mockDio.get<dynamic>(
          '/groups/eligible-friend-groups/',
          queryParameters: <String, dynamic>{'user_id': friendId},
        ),
      ).called(1);
    });
  });
    ...
    test('merges top-level currency into each suggestion', () async {
      when(
        ...
        (_) async => Response<Map<String, dynamic>>(
          ...
          statusCode: 200,
          requestOptions: RequestOptions(
            path: '/groups/$_groupId/balances/simplified/',
          ),
        ),
      );
  ...
  group('createGroup', () {
    test(
      'sends POST /groups/ with body and returns GroupDetailModel on 201',
      () async {
  ...
  group('updateGroup', () {
    test('propagates DioException with nested ApiException on 400', () async {
      when(
  ...
  group('addMember', () {
    test('sends POST /groups/{id}/members/ with user_id and role', () async {
      when(
        () => mockDio.post<Map<String, dynamic>>(
          '/groups/$_groupId/members/',
          data: any(named: 'data'),
    ...
    test('calls PATCH /groups/{id}/members/{userId}/ with role body', () async {
      ...
      when(
        ...
        (_) async => Response<Map<String, dynamic>>(
          ...
          statusCode: 200,
          requestOptions: RequestOptions(
            path: '/groups/$_groupId/members/$userId/',
          ),
        ),
      );
